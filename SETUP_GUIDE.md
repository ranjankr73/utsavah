...
3. **Set Up Database Access (Credentials)**:
    ...
    - Set a Username (e.g., `utsavahadmin`) and a Password (e.g., `utsavahpassword`). **Remember these.**
    - Click **Add User**.
...
5. **Get Your Connection String**:
    ...
    - Copy the connection string provided. It will look something like this:
      `mongodb+srv://utsavahadmin:<password>@cluster0.xxxxx.mongodb.net/?retryWrites=true&w=majority`
...
5. Generate a new App Password (select "Other" and name it "Utsavah").
...
MONGO_URI=mongodb+srv://utsavahadmin:your_actual_password@cluster0.xxxxx.mongodb.net/utsavah?retryWrites=true&w=majority

# This can be any random string, but keep it secure.
JWT_SECRET=supersecretjwtkey_utsavah
...
I have included an export file named `Utsavah_Postman_Collection.json` in the root of the project. This contains every API route pre-configured.

1. Open [Postman](https://www.postman.com/downloads/).
2. Click **Import** (top left).
3. Drag and drop the `Utsavah_Postman_Collection.json` file into the window.
