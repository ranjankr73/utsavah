...
const users = [
    {
        name: "Admin User",
        email: "admin@utsavah.com",
        password: "Password@123",
        role: "admin",
    },
    {
        name: "Demo User",
        email: "user@utsavah.com",
        password: "Password@123",
        role: "user",
    },
    {
        name: "Alice Smith",
        email: "alice@utsavah.com",
        password: "Password@123",
        role: "user",
    },
    {
        name: "Bob Johnson",
        email: "bob@utsavah.com",
        password: "Password@123",
        role: "user",
    },
    {
        name: "Charlie Dave",
        email: "charlie@utsavah.com",
        password: "Password@123",
        role: "user",
    },
    {
        name: "Diana Prince",
        email: "diana@utsavah.com",
        password: "Password@123",
        role: "user",
    },
    {
        name: "Ethan Hunt",
        email: "ethan@utsavah.com",
        password: "Password@123",
        role: "user",
    },
    {
        name: "Fiona Gallagher",
        email: "fiona@utsavah.com",
        password: "Password@123",
        role: "user",
    },
    {
        name: "George Miller",
        email: "george@utsavah.com",
        password: "Password@123",
        role: "user",
    },
    {
        name: "Hannah Montana",
        email: "hannah@utsavah.com",
        password: "Password@123",
        role: "user",
    },
];
...
const seedDatabase = async () => {
    try {
        await mongoose.connect(
            process.env.MONGO_URI || "mongodb://localhost:27017/utsavah",
        );
        ...
        console.log("-------------------------------------------");
        console.log("Admin Email: admin@utsavah.com");
        console.log("User Email:  user@utsavah.com");
